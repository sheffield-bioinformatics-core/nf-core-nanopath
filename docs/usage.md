...
## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/nanopath/usage](https://nf-co.re/nanopath/usage)
...
```bash
nextflow run nf-core/nanopath --input samplesheet.csv --outdir <OUTDIR> --genome GRCh37 -profile docker
```
